...
adv_img_file = Image.open("D:\MultipleAttack\test_ES_lambda=50_epsilon=0.01_maxiter=1_pretrained=llava-onevision-qwen2-7b-ov/0/adv.png")
...
image_tensor_load = torch.load("D:\MultipleAttack\test_ES_lambda=50_epsilon=0.01_maxiter=1_pretrained=llava-onevision-qwen2-7b-ov/0/adv.pt")
