...
input_ids, image_tensors, image_sizes = model.repair_input("Descibe image", img_files)
...
input_ids, image_tensors, image_sizes = model.repair_input("Descibe image", decoded_image_pil)
tensor_output = model.inference(input_ids, image_tensors, image_sizes)
